            ...
            children: [
              ...
              Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    child: Center(child: FlutterBulletList(data: state,bulletColor: Colors.pinkAccent,spaceBetweenItem:15,bulletType: BulletType.square,bulletSize: 2,textStyle: TextStyle(fontSize: 20,color:
                    Colors.white),)),
                  )),
            ],
          ),
